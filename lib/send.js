...
// The SDK's ESM build takes named imports from anchor, which is CommonJS, and
// Node's ESM loader rejects that. Its CJS build resolves the same code fine.
const { SecuritizeBridgeClient } = createRequire(import.meta.url)('@securitize/solana-bridge-sdk');
