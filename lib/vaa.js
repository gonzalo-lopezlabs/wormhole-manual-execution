 ...
 */
async function findVaaByTxHash(network, txHash, expectedChain) {
...
async function fetchVaa(network, emitterChain, emitterHex, sequence) {
  const base = WORMHOLESCAN[network];
...
module.exports = { findVaaByTxHash, fetchVaa, parseVaa, decodePayload };
